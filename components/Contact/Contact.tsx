import { Container, Grid, Text, Title, Group, ActionIcon } from '@mantine/core';
    ...
    <Container size="md" className={classes.container} id="contact">
      <Grid justify="center" align="center" gutter={60}>
        <Grid.Col span={10}>
          ...
          >
            I&apos;m currently looking for a PhD position or full-time job in robotics. If you have
            any questions or would like to get in touch, please contact me via email or LinkedIn.
          </Text>
